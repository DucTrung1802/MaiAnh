...
void PDMA_CH2_5_IRQHandler(void)
{
  ...
  if (PDMA_GetFlagStatus(PDMA_USART1_RX, PDMA_FLAG_BE))
  {
    /* Clear interrupt flags                                                                                */
    PDMA_ClearFlag(PDMA_USART1_RX, PDMA_FLAG_BE);
  ...
  if (PDMA_GetFlagStatus(PDMA_USART1_RX, PDMA_FLAG_TC))
  {
    /* Clear interrupt flags                                                                                */
    PDMA_ClearFlag(PDMA_USART1_RX, PDMA_FLAG_TC);

    gIsUxART_PDMA_TxBusy = FALSE;
    USART_PDMACmd(HT_USART1, USART_PDMAREQ_TX, DISABLE);
  }
